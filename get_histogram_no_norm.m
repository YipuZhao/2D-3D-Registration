function [MI_hist, MI_prob] = get_histogram_no_norm(points_gray, value_gray, points_refc, value_refc, nbins)
...
%     disp('1------');
%     tic
    edge_gray = linspace(value_gray(1), value_gray(2), nbins);
    edge_refc = linspace(value_refc(1), value_refc(2), nbins);
    
    [hist_gray, ~, bin_idx_gray] = histcounts(points_gray,edge_gray);
    [hist_refc, ~, bin_idx_refc] = histcounts(points_refc,edge_refc);
